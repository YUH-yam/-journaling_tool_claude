...
3. `https://◯◯◯.netlify.app/index.html` のURLが発行される
...
数分後 `https://<USER>.github.io/<REPO>/index.html` で公開されます。

### 方法3: ローカル試用(同じネットワーク内のスマホから)

```bash
python3 -m http.server 8080
# 別端末から http://<PCのIP>:8080/index.html
